...
export default function Xrays_visit() {
    return (
        <>
            <Navbar />
            <div className={styles.vHeader}>
                <div>
                    <h1 className={styles.title}>Visit - X-rays View</h1>
                </div>
            ...
            <div className={styles.components}>
                ...
                <div>
                    ...
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="user_avatar">X-Ray Results</label>
