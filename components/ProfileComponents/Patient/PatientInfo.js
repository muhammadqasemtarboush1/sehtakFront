...
async function getProfileInfo() {
  ...
  return (
    ...
    :
        ...
        <div className='p-4 mt-10 bg-blue-300 rounded-lg'>
            <div className='flex justify-between my-4 mb-6'> <span className='text-3xl font-semibold text-blue-700'> {patientData?.first_name} {patientData?.last_name} </span> <Link href="UserEditData"><span className='p-2 text-xl text-white bg-blue-600 rounded-xl hover:cursor-pointer'>Edit</span></Link> </div>
            ...
            <div className='flex mt-3 ml-5'> <div> <span className='font-medium text-l text-sky-500'>Height</span> <span className='font-medium text-sky-600'>{patientData?.height}</span></div> <div className='ml-3'><span className='font-medium text-l text-sky-600'>Weight</span> <span className='font-medium text-sky-600'>{patientData?.weight}</span></div></div> 
